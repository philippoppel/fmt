...
// Extended with new matching algorithm fields
const therapists = [
  {
    userId: 'seed-user-1',
  ...
  },
  {
    ...
    reviewCount: 42,
    isPublished: true,
    // Premium with 20 years experience - perfect for high intensity
    accountType: 'premium' as const,
    experienceYears: 20,
    isVerified: true,
  ...
  },
  {
    ...
    reviewCount: 18,
    isPublished: true,
    // Mittel account - less experience
  ...
  },
  {
    ...
    reviewCount: 31,
    isPublished: true,
    // Premium, ONLINE ONLY - tests session type filter
    accountType: 'premium' as const,
    experienceYears: 8,
    isVerified: true,
  ...
  },
  {
    ...
    reviewCount: 56,
    isPublished: true,
    // Premium trauma specialist - 12 years
    accountType: 'premium' as const,
    experienceYears: 12,
    isVerified: true,
  ...
  // Additional therapists for better matching coverage
  {
    userId: 'seed-user-6',
    ...
    reviewCount: 38,
    isPublished: true,
    // Mittel account - eating disorders specialist
    accountType: 'mittel' as const,
    experienceYears: 7,
    isVerified: true,
  ...
  },
  {
    ...
    reviewCount: 29,
    isPublished: true,
    // GRATIS account - tests account type restrictions
  ...
  },
  {
    ...
    reviewCount: 22,
    isPublished: true,
    // Mittel ADHD specialist - online only
    accountType: 'mittel' as const,
    experienceYears: 6,
    isVerified: true,
  ...
  },
  {
    ...
    reviewCount: 53,
    isPublished: true,
    // Premium executive coach - very experienced
    accountType: 'premium' as const,
    experienceYears: 22,
    isVerified: true,
  ...
  },
  {
    ...
    reviewCount: 34,
    isPublished: true,
    // Premium multilingual trauma specialist - speaks Arabic!
    accountType: 'premium' as const,
    experienceYears: 9,
    isVerified: true,
  ...
  },
  {
    ...
    reviewCount: 28,
    isPublished: true,
    // Premium - no German language (tests language filter won't apply here since she speaks DE)
    accountType: 'premium' as const,
    experienceYears: 11,
    isVerified: true,
  ...
  },
  {
    ...
    reviewCount: 32,
    isPublished: true,
    // Mittel - Arabic speaking (tests language matching)
    accountType: 'mittel' as const,
    experienceYears: 8,
    isVerified: true,
